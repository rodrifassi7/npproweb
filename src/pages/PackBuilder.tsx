...
import { Minus, Plus, ShoppingCart, Info, ShieldCheck } from 'lucide-react';
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="flex-1">
                        <header className="mb-10">
                            ...
                            <p className="text-nppro-gray">Seleccioná al menos 5 viandas para activar los descuentos por volumen.</p>
                        </header>
                                    ...
                                    <div key={product.id} className="glass p-4 sm:p-6 rounded-3xl flex items-center gap-4 sm:gap-6 group hover:border-nppro-green/30 transition-all">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center gap-4 mt-1">
                                                ...
                                                {product.macros && <span className="text-[10px] text-nppro-gray uppercase font-bold">{product.macros.kcal} kcal</span>}
                                            </div>
                                        </div>
                        ...
                        <div className="sticky top-32 glass p-8 rounded-[40px] border-white/10">
                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-nppro-green/10 rounded-2xl border border-nppro-green/20 flex items-center gap-3">
                                    ...
                                    <p className="text-xs font-medium">Sumamos opción de envasado al vacío en el checkout.</p>
                                </div>
                                <a href="/checkout" className="btn-primary w-full py-4 text-center">
                                    Continuar al checkout
                                </a>
                                <p className="text-[10px] text-nppro-gray text-center uppercase tracking-widest font-bold">
                                    Sin pago online • Pedido por WhatsApp
                                </p>
                            </div>
                        </div>
                    </div>
